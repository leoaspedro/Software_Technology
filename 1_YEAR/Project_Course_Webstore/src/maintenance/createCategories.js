...
const BASE_HREF = 'https://www.bikester.co.uk/';
const BIKE_HREF = BASE_HREF + 'bikes/';
const products = {
  categories: [
    {
      url: BIKE_HREF + 'mountain-bikes.html',
    ...
    {
      url: BIKE_HREF + 'electric-bikes.html',
    ...
    {
      url: BASE_HREF + 'parts/cassettes-chains/chains.html',
      category: 'Chains',
    ...
    {
      url: BASE_HREF + 'parts/suspension-forks.html',
      category: 'Forks',
    ...
    {
      url: BASE_HREF + 'parts/safety-equipment/bike-bells.html',
      category: 'Bells',
    ...
    {
      url: BASE_HREF + 'parts/bike-saddles.html',
      category: 'Saddles',
    ...
    {
      url: BASE_HREF + 'accessories/bike-stands.html',
      category: 'Stands',
    ...
    {
      url: BASE_HREF + 'parts/tyres-tubes/inner-tubes.html',
    ...
    {
      url: BASE_HREF + 'parts/cassettes-chains/cassettes.html',
      category: 'Cassettes',
    ...
    {
      url: BASE_HREF + 'parts/bike-gears.html',
      category: 'Shifting Components',
      categoryId: 'bndCIVX6at1ar0VNXk9y',
      productList: [],
    },
    {
      url: BASE_HREF + 'parts/grips-handlebar-tape/grips.html',
      category: 'Grips',
      categoryId: 'jQ3rwW8CRZ3FCMd18fpl',
      productList: [],
    },
    {
      url: BASE_HREF + 'parts/brakes.html',
      category: 'Brakes',
      categoryId: 'm3utlwz7Gsz79R0T6cQy',
      productList: [],
    },
    {
      url: BASE_HREF + 'accessories/bike-lights.html',
      category: 'Lights',
      categoryId: 'n06iE1VaN7eNI44fskkE',
      productList: [],
    },
    {
      url: BASE_HREF + 'accessories/bike-locks.html',
      category: 'Locks',
      categoryId: 'nvOTggIQW6Z5mbMosTqW',
      productList: [],
    },
    {
      url: BASE_HREF + 'accessories/bike-pumps.html',
      category: 'Pumps',
    ...
    {
      url: BASE_HREF + 'parts/bike-tyres.html',
      category: 'Tyres',
      categoryId: 'r3DzTJKTS0t79P6qZtUu',
      productList: [],
    },
    {
      url: BASE_HREF + 'parts/pedals.html',
      category: 'Pedals',
